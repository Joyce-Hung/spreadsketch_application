...
def main():
    ...
    for port in args.thrift_ports:
        ...
        for level in range(33):
            rule = "MyIngress.cal_level MyIngress.compute_level 0.0.0.0/{0} => {0}".format(level)
            RuntimeAPI(args.pre, standard_client, mc_client).do_table_add(rule)
    '''
    #RuntimeAPI(args.pre, standard_client, mc_client).cmdloop()
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/0 => 0")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/1 => 1")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/2 => 2")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/3 => 3")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/4 => 4")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/5 => 5")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/6 => 6")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/7 => 7")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/8 => 8")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/9 => 9")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/10 => 10")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/11 => 11")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/12 => 12")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/13 => 13")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/14 => 14")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/15 => 15")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/16 => 16")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/17 => 17")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/18 => 18")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/19 => 19")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/20 => 20")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/21 => 21")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/22 => 22")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/23 => 23")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/24 => 24")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/25 => 25")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/26 => 26")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/27 => 27")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/28 => 28")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/29 => 29")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/30 => 30")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/31 => 31")
    RuntimeAPI(args.pre, standard_client, mc_client).do_table_add("MyIngress.cal_level MyIngress.compute_level 0.0.0.0/32 => 32")
       
    # added new defined egress rule
    #egress_api = RuntimeAPI(None, standard_client, mc_client)
    #egress_api.do_table_add("MyEgress.hash_forward MyEgress.set_port_by_hash 0 => 2")
    #egress_api.do_table_add("MyEgress.hash_forward MyEgress.set_port_by_hash 1 => 3")
